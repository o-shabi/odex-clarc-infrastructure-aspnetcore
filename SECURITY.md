...
1. **[GitHub Security Advisory](https://github.com/o-shabi/odex-clarc-infrastructure-aspnetcore/security/advisories/new)** for this repository (preferred when enabled), or  
